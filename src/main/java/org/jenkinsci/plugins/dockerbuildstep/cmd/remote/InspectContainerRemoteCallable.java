 ...
 */
public class InspectContainerRemoteCallable implements Callable<InspectContainerResponse, Exception>, Serializable {
    ...
    public InspectContainerRemoteCallable(Config cfgData, Descriptor<?> descriptor, String id) {
